        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <a href={"https://wa.me/" + profile.whatsapp} target="_blank" className="flex items-center justify-center bg-emerald-500 hover:bg-emerald-600 text-white py-4 rounded-2xl font-bold transition-all">WhatsApp</a>
              <a href={"https://t.me/" + profile.telegram} target="_blank" className="flex items-center justify-center bg-sky-500 hover:bg-sky-600 text-white py-4 rounded-2xl font-bold transition-all">Telegram</a>
            </div>
          </div>
        </div>
      </div>
